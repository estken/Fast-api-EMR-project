...
from crud.depratments_type_crud import create_department_type
from auth import validate_active_client

# router configuration
user_departments_type_router = APIRouter(
    prefix="/departments",
    tags=["User Departments"],
)

# endpoint to create department type
@user_departments_type_router.post("/create/department_type", summary="create a department type", status_code=201)
